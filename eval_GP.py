...
from utils.GlobalPointer import GPDataMaker, GlobalPointer, MetricsCalculator
...
def data_generator(data_type="predict"):
    ...
    if data_type == "predict":
        predict_dataloader = DataLoader(predict_data,
                                    ...
                                    drop_last=False,
                                    collate_fn=lambda x: data_maker.generate_batch(x, max_seq_len, ent2id, data_type="predict")
                                    )
