import os, sys, json, torch, time, glob
from transformers import BertTokenizerFast, BertModel

#internal
from utils.utils import multicat_crossentropy
from utils.dataset import GPDataset
from utils.GlobalPointer import GPreprocessor,GPDataMaker, GlobalPointer, MetricsCalculator
from torch.utils.data import DataLoader, Dataset
from tqdm import tqdm
import config
from eval_GP import load_model
...
def data_generator(data_type="train"):
    ...
    data_maker = GPDataMaker(tokenizer)
    ...
    if data_type == "train":
        ...
        train_dataloader = DataLoader(GPDataset(train_data),
        ...
        valid_dataloader = DataLoader(GPDataset(valid_data),
                                        batch_size=hyper_parameters["batch_size"],
                                        shuffle=True,
                                        num_workers=config["num_workers"],
                                        drop_last=False,
...
def train(model, dataloader, epoch, optimizer):
    ...
    def loss_fun(y_true, y_pred):
        ...
        loss = multicat_crossentropy(y_true, y_pred)
        return loss
